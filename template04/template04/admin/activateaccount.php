      ...
      <table width="600"  border="0" align="center">
        <tr>
          <td colspan="2" class="big_title"><div align="left">
            <p align="center">              Are you shure you want to activate this account:</p>
        ...
        <tr align="center">
          <td width="300" class="big_title"><a href="doactivateaccount.php?id=<? echo $_POST['id'];?>&type=<? echo $_POST['type']; ?>&username=<?echo $_POST['username'];?>">Yes, activate the account</a> </td>
