...
<?
	...
	?>
<table width="720" height="98" align="center" class="form_definitions">
  <tr>
    <td width="96" height="96" align="center" valign="middle"><img height="96" width="96" src="../models/<? echo $tempUser."/thumbnail.jpg" ?>"></td>
    <td width="312" valign="bottom"><strong class="big_title">Details for <? echo $tempName; ?><br>
        ...
        <tr>
          <form name="form1" method="post" action="deleteaccount.php">
            <td width="292" height="30">
              ...
              <input name="date" type="hidden" id="username" value="<? echo $date; ?>"></td>
          </form>
        </tr>
        <tr>
<? if($status!='blocked'){ 
...
?> 
              ...
              <input name="date" type="hidden" id="date23" value="<? echo $date; ?>">                          </td>
          </form>
        </tr>
        <tr>
...
<table width="720"  border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
  <tr>
    <td width="360" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="2">
        <tr>
        ...
        <tr>
          <td align="left" valign="top" class="form_definitions">Bra Size</td>
          <td align="left" valign="top" class="form_definitions"><? echo $tBraS; ?></td>
        </tr>
        <tr>
          <td align="left" valign="top" class="form_definitions">Birth Sign</td>
          <td align="left" valign="top" class="form_definitions"><? echo $tBirthS; ?></td>
        </tr>
        <tr>
        ...
        <tr>
          <td align="left" valign="top" class="form_definitions">Ethnicity</td>
        ...
        <tr>
          <td align="left" valign="top" class="form_definitions">Pubic hair</td>
          <td align="left" valign="top" class="form_definitions"><? echo $tPhair; ?></td>
        </tr>
        <tr>
          <td align="left" valign="top" class="form_definitions">Broadcasting from</td>
    ...
    <td width="360" valign="top" bgcolor="#FFFFFF"><table width="100%"  border="0" cellpadding="0" cellspacing="2">
        <tr>
        ...
        <tr class="form_definitions">
          <td width="100" align="left">SSN(USA only) </td>
          <td><? echo $tempSs; ?></td>
        </tr>
        <tr class="form_definitions">
          <td width="100" align="left">Yahoo</td>
          <td><? echo $tempYahoo; ?></td>
        </tr>
        <tr class="form_definitions">
          <td width="100" align="left">Msn</td>
          <td><? echo $tempMsn; ?></td>
        </tr>
        <tr class="form_definitions">
          <td width="100" align="left">Icq</td>
          <td><? echo $tempIcq; ?></td>
        </tr>
        <tr>
          <td width="100" align="left" valign="top" class="form_definitions">Fax</td>
          <td align="left" valign="top" class="form_definitions"><? echo $tempFax; ?></td>
        </tr>
        <tr>
          <td width="100" align="left" valign="top" class="form_definitions">&nbsp;</td>
          <td align="left" valign="top" class="form_definitions">&nbsp;</td>
        </tr>
        <tr>
	  ...
	  ?>
        ...
        <tr>
          <td align="left" class="form_definitions">Studio:</td>
	  ...
	  if ($tOwner!="none"){
        ...
        <tr>
          <td align="left" class="form_definitions">&nbsp;</td>
          <td align="left" class="form_definitions">&nbsp;
          </td>
        </tr>
        <tr>
...
<form name="form1" method="post" action="">
  <table width="720"  border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#dddddd" class="form_definitions">
    <tr>
      <td bgcolor="#FFFFFF"><p> Earning percentage (e.g: 30 or 40)<br>
          ...
          cents (that means <? echo $cpm/100 ?> $ per minute<br>
          Note:in the falsh interface the accounts are upadted each 30 seconds in advance<br>
...
?>
<table width="720" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#dddddd">
  <tr>
    <td bgcolor="#FFFFFF" class="small_title"><p class="message"><span class="message">The model  earned so far:<? echo $tempMoneyEarned;?>$</span><br>
      The site earned due to this models' activity:<? echo $sitemoney; ?><br>
        Money in her account (not yet paid):<? echo $tempMoneyEarned-$tempMoneySent ?>$ <br>
      Money she earned in last 7 days: <? echo $tempMoneyEarned30; ?> $ </p>      </td>
  </tr>
</table>
<br>
<table width="720" align="center" class="form_definitions">
  <tr>
    <td><strong class="a_small_title">Attached Identity Act Picture (<? echo $tempIdtype; ?>)<br>
...
<table width="720" align="center" class="form_definitions">
  <tr>
    <td><strong class="a_small_title">Attached Representative Picture </strong></td>
  </tr>
  <tr>
