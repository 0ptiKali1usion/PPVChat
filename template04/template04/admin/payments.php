...
<table width="720" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#333333">
  <tr>
    <td bgcolor="#FFFFFF" class="form_definitions"><p><br>
	...
	$tempMoneySent=0;
			...
			while($row2 = mysql_fetch_array($result2)) 
				...
				echo'<table class="form_definitions" width="700" bgcolor="#efefef" border="0" align="center" cellpadding="2" cellspacing="1">
					<tr>
					<td bgcolor="eeeeee" >'.$count.') <a href=modelviewdetails.php?id='.$row2[id].'>'.$row2[name].'</a> ( '.$row2[email].' )</td>
					<td bgcolor="eeeeee"><b>Ammount: '.$total .' US Dollars</b></td>
					</tr> 
					<tr>
					<td bgcolor="ffffff"><p><b>Method:</b> '.$row2[pMethod].'<br><b>Details:</b>'.$row2[pInfo].'</p></td>
					<td valign="middle" bgcolor="ffffff">
					<form name="form1" method="post" action="markpaymentassent.php">
					<input type="submit" name="Submit" value="Mark Payment as sent"> 
...
while($row = mysql_fetch_array($result)) {
	...
	echo'<table class="form_definitions" width="700" bgcolor="#efefef" border="0" align="center" cellpadding="2" cellspacing="1">
		<tr>
		<td bgcolor="eeeeee" >'.$count.') <a href=sopviewdetails.php?id='.$row[id].'>'.$row[name].'</a> ( '.$row[email].' )</td>
		<td bgcolor="eeeeee"><b>Ammount: '.$total .' US Dollars</b></td>
		</tr> 
		<tr>
		<td bgcolor="ffffff"><p><b>Method:</b> '.$row[pMethod].'<br><b>Details:</b>'.$row[pInfo].'</p></td>
		<td valign="middle" bgcolor="ffffff">
