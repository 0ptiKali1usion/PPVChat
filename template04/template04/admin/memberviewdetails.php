...
?> 
	...
	<table width="600" align="center" class="form_definitions">
      <tr>
        <td width="162" align="right"><strong>Money in Virtual Wallet:</strong></td>
        <td width="426"><strong><? echo $tempMoney; ?> USD </strong></td>
      </tr>
    ...
    cents</td>
          <td width="310">
            <input type="submit" name="Submit" value="Deposit money in his Virtual Wallet">
            <input name="username" type="hidden" id="username" value="<? echo $tempUser;?>">
	  ...
	  <form name="form2" method="post" action="removemoney.php">
        ...
        cents</td>
            <td width="310">
              <input type="submit" name="Submit2" value="Remove money from his Virtual Wallet">
              <input name="username" type="hidden" id="username" value="<? echo $tempUser;?>">
              <input name="email" type="hidden" id="email" value="<? echo $tempEmail;?>">
