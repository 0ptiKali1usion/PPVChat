...
function LoadJpeg ($imgname,$tocreate) {
	...
	echo "<font color=#ffdd54>The image thumbnail could not be created. The image file might be corrupted.</font><br> You can can resave the file by using any image editor and then try again<br><br>Thank You! $endstr ";
   ...
   $result=true;
 	...
 	$result=false;
		  	...
		  	$errorMsg="Thumbnail file could not be created";
    ...
    <td height="113"><form action="uploadpicture.php" method="post" enctype="multipart/form-data" name="form2">
        ...
        <table width="720" border="0" align="center" cellpadding="4" cellspacing="0">
          ...
          <tr class="barbg">
            ...
            <td colspan="2"><span class="form_header_title">Upload New Picture</span></td>
          </tr>
        ...
        <table width="720" border="0" align="center" cellpadding="4" cellspacing="0">
          ...
          <tr class="barbg">
            ...
            <td class="barbg"><span class="form_header_title">Picture  Gallery </span></td>
          ...
          <tr>
			...
			echo "<td width='100'class='form_definitions' height='100' align='center' valign='middle'><img src ='../../models/".$username."/".$row[name]."_thumbnail.jpg' ><br><a class=left href='uploadpicture.php?delete=$row[name]'>Delete</a></td>";
