...
<table width="720" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr valign="top">
    ...
    <td height="113"><span class="big_title">Update Model Profile </span><span class="error"><br>
      <br>
      ...
      <form action="updateprofile.php" method="post" enctype="multipart/form-data" name="form2">
        ...
        <table width="720" border="0" align="center" cellpadding="4" cellspacing="0">
          ...
          <tr class="barbg">
            ...
            <td colspan="3" class="form_header_title">Thumbnail Image</td>
          </tr>

          <tr>

            <td width="109" align="right" class="form_definitions">Thumbnail Image:</td>

            <td width="96"><img src="../../models/<? echo $username; ?>/thumbnail.jpg" width="140" height="105"></td>

            <td width="491"><input name="ImageFile" type="file" id="ImageFile">

                <input type="submit" name="Submit2" value="Change">

                <br>

                <span class="form_informations style1">Recommended size: 140 x 105 px </span></td>
      ...
      <form name="form1" method="post" action="updateprofile.php">
        ...
        <table width="720" border="0" align="center" cellpadding="4" cellspacing="0">
          ...
          <tr>
            ...
            <td align="right" class="form_definitions">New	Passsword:
        ...
        <div align="center">
          ...
          <table width="720" border="0" cellspacing="0" cellpadding="4">
            ...
            <tr align="left" class="barbg">
              ...
              <td colspan="3" class="form_header_title">Profile Information </td>
            </tr>
            ...
            <tr>
              ...
              <td align="right" valign="top" class="form_definitions"> Language 3: </td>

              <td align="left" valign="top"><select name="L3" id="L3">

                  <option value="none"  <? if ($tL3=="none"){echo "selected";}?> >None</option>

                  <option value="Dutch"  <? if ($tL3=="Dutch"){echo "selected";}?> >Dutch</option>

                  <option value="English" <? if ($tL3=="English"){echo "selected";}?> >English</option>

                  <option value="French" <? if ($tL3=="French"){echo "selected";}?> >French</option>

                  <option value="German" <? if ($tL3=="German"){echo "selected";}?> >German</option>

                  <option value="Italian" <? if ($tL3=="Italian"){echo "selected";}?> >Italian</option>

                  <option value="Japanese" <? if ($tL3=="Japanese"){echo "selected";}?> >Japanese</option>

                  <option value="Korean" <? if ($tL3=="Korean"){echo "selected";}?> >Korean</option>

                  <option value="Portuguese" <? if ($tL3=="Portuguese"){echo "selected";}?> >Portuguese</option>

                  <option value="Spanish" <? if ($tL3=="Portuguese"){echo "selected";}?> >Spanish</option>
            ...
            <tr>
              ...
              <td align="right" valign="top" class="form_definitions">              Language 4: </td>

              <td align="left" valign="top"><select name="L4" id="L4">

			  	<option value="none"  <? if ($tL4=="none"){echo "selected";}?> >None</option>

                <option value="Dutch"  <? if ($tL4=="Dutch"){echo "selected";}?> >Dutch</option>

                <option value="English" <? if ($tL4=="English"){echo "selected";}?> >English</option>

                <option value="French" <? if ($tL4=="French"){echo "selected";}?> >French</option>

				<option value="German" <? if ($tL4=="German"){echo "selected";}?> >German</option>

				<option value="Italian" <? if ($tL4=="Italian"){echo "selected";}?> >Italian</option>

				<option value="Japanese" <? if ($tL4=="Japanese"){echo "selected";}?> >Japanese</option>

				<option value="Korean" <? if ($tL4=="Korean"){echo "selected";}?> >Korean</option>

				<option value="Portuguese" <? if ($tL4=="Portuguese"){echo "selected";}?> >Portuguese</option>

				<option value="Spanish" <? if ($tL4=="Portuguese"){echo "selected";}?> >Spanish</option>
		  ...
		  ?>
            ...
            <tr>
              ...
              <td align="right" valign="top" class="form_definitions">Bra Size: </td>

              <td align="left" valign="top"><input name="BraSize" type="text" id="BraSize" value="<? echo $tBraS;  ?>" size="24" maxlength="24"></td>
            ...
            <tr>
              ...
              <td align="right" valign="top" class="form_definitions">Birth Sign: </td>

              <td align="left" valign="top"><input name="BirthSign" type="text" id="BirthSign" value="<? echo $tBirthS;  ?>"size="24" maxlength="24"></td>
            ...
            <tr>
              ...
              <td align="left" valign="top"><input name="Height" type="text" id="Height" value="<? echo $tHeight;  ?>" size="4" maxlength="4">

                <select name="heightMeasure" id="select2">

                  <option value="cm" <? if ($tHeightM=="cm"){echo "selected";}?> >Centimeters</option>

                  <option value="in" <? if ($tHeightM=="in"){echo "selected";}?>  >Inch</option>
            ...
            <tr>
              ...
              <td align="right" valign="top" class="form_definitions">Ethinicity:</td>
            ...
            <tr>
              ...
              <td align="left"><input name="pubicHair" type="text" id="pubicHair" size="24" value="<? if (isset($tPhair)){ echo $tPhair; }  ?>" maxlength="24"></td>
            ...
            <tr>
              ...
              <td align="left" valign="top" class="form_informations style1">&nbsp;</td>
            ...
            <tr>
              ...
              <td align="right" valign="top" class="form_definitions">Favourite Position:</td>
            ...
            <tr>
              ...
              <td height="12" align="left" class="style1">&nbsp;</td>
            ...
            <tr>
              ...
              <td align="left" valign="top"><select name="Category" id="Category">
          ...
          <table width="720" border="0" cellspacing="0" cellpadding="4">
            ...
            <tr>
              ...
              <td colspan="3"><div align="left" class="form_definitions">
  
 This information is kept confidential and never disclosed to other parties. We use the information to verify your identity.
...
Fax:              </td>
            ...
            <tr>
              ...
              <td align="left"><input name="msn" value="<? if (isset($tempMsn)){ echo $tempMsn; }  ?>" type="text" id="msn" size="24" maxlength="24"></td>
            ...
            <tr>
              ...
              <td align="left"><input name="yahoo" value="<? if (isset($tempYahoo)){ echo $tempYahoo; }  ?>" type="text" id="ZipCode33" size="24" maxlength="24"></td>
            ...
            <tr>
              ...
              <td align="left"><input name="icq" value="<? if (isset($tempIcq)){ echo $tempIcq; }  ?>" type="text" id="ZipCode32" size="24" maxlength="24"></td>
          ...
          <table width="720" border="0" cellspacing="0" cellpadding="4">
            ...
            <tr>
              ...
              <td align="left" valign="top" class="form_definitions"><div align="right">Payment Method:</div></td>
            ...
            <tr>
              ...
              <td align="left" valign="top" class="form_definitions"><div align="right">Payment Information:</div></td>
            ...
            <tr>
              ...
              <td align="left" valign="top"><input type="submit" name="Submit" value="   Save My Changes   "></td>
